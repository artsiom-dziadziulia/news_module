...
namespace Aw\Test\Ui\Component\Listing\Column;
...
class NewsBlockActions extends Column
{
     ...
     * Entity name.
     */
    private const ENTITY_NAME = 'News';

    /**
     * Url paths.
     */
    private const EDIT_URL_PATH = 'news/news/edit';
    private const DELETE_URL_PATH = 'news/news/delete';
    ...
    public function prepareDataSource(array $dataSource): array
    {
        if (isset($dataSource['data']['items'])) {
            foreach ($dataSource['data']['items'] as &$item) {
                if (isset($item[NewsInterface::NEWS_ID])) {
                    $entityName = static::ENTITY_NAME;
                    $urlData = [NewsInterface::NEWS_ID => $item[NewsInterface::NEWS_ID]];
